 ...
 * @see TripleClimber
 */
public class RobotTask1 implements Runnable{
	...
	public void run() {
		...
		Climber karel = null;
		// create a new robot
		karel = new DoubleClimber(field, 6, 0, Direction.EAST, 50);
		karel.climbAndPlant();	
		karel = new TripleClimber(field, karel.getStreet(), karel.getAvenue(), Direction.EAST, 50);
		karel.climbAndPlant();
		karel.climbAndPlant();
		karel = new DoubleClimber(field, karel.getStreet(),karel.getAvenue(), Direction.EAST, 50);
		karel.climbAndPlant(); 
